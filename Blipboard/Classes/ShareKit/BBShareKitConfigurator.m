//
//  BBShareKitConfigurator.m
//  Blipboard
//
//  Created by Aneil Mallavarapu on 4/1/13.
//  Copyright (c) 2013 Blipboard. All rights reserved.
//

#import "BBShareKitConfigurator.h"

@implementation BBShareKitConfigurator
...
- (NSString*)twitterConsumerKey {
	return @"0lkldMGRZgg8qxq6TXB1MA";
}

- (NSString*)twitterSecret {
	return @"Jo66kERnmEV1eSQ7mELK3uNgkDsMVkrND7efESmzk";
}
...
- (NSArray*)defaultFavoriteURLSharers {
    return [NSArray arrayWithObjects:@"BBFacebookSharer",@"SHKTwitter", nil];
}
...
- (Class)SHKActionSheetSubclass {
    return NSClassFromString(@"BBShareKitActionSheet");
}

- (Class)SHKShareMenuSubclass {
    return NSClassFromString(@"BBShareKitShareMenu");
}

- (Class)SHKShareMenuCellSubclass {
    return NSClassFromString(@"BBShareKitTableViewCell");
}

- (Class)SHKFormControllerSubclass {
    return NSClassFromString(@"BBShareKitFormController");
}
